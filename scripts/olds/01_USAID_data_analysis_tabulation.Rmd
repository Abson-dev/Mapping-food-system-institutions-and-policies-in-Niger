...
tbl_cov = tab1 %>% tbl_summary( 
                           type = list(c(region)  ~ "categorical"),
                            #statistic = list(all_continuous() ~ "{mean}({sum})"),
...
EVALUATION_DES_CAPACITES_Hema  %>% dplyr::select(dom_1,
                                          q_ii_8_1_1,
q_ii_8_2_1,
q_ii_8_3_1,
q_ii_8_4_1,
...
q_ii_9_96_1) ~ "continuous"),
       ...
       statistic = list(all_continuous() ~ "{mean}({sum})"),#({sum})
          digits = everything() ~ c(2,0), missing = "no") %>%
 modify_header(label = "") %>%
  add_overall() %>%
  add_n() %>%  
...
EVALUATION_DES_CAPACITES_Hema  %>% dplyr::select(dom_2,
                                                 q_ii_8_1_2,
                                                 q_ii_8_2_2,
                                                 q_ii_8_3_2,
                                                 q_ii_8_4_2,
...
EVALUATION_DES_CAPACITES_Hema  %>% dplyr::select(dom_3,
                                                 q_ii_8_1_3,
                                                 q_ii_8_2_3,
                                                 q_ii_8_3_3,
                                                 q_ii_8_4_3,
...
EVALUATION_DES_CAPACITES_Hema  %>% dplyr::select(dom_4,
                                                 q_ii_8_1_4,
                                                 q_ii_8_2_4,
                                                 q_ii_8_3_4,
                                                 q_ii_8_4_4,
...
EVALUATION_DES_CAPACITES_Hema  %>% dplyr::select(dom_5,
                                                 q_ii_8_1_5,
                                                 q_ii_8_2_5,
                                                 q_ii_8_3_5,
                                                 q_ii_8_4_5,
